namespace Tasks.Task3.Reference;
...
public class UnitTest
{
    ...
    public void Test()
    {
        ...
        var printList = list.Select(obj => obj switch
        {
            Object1 obj1 => $"Object #{obj1.Id} has the name {obj1.Name}",
            Object2 obj2 => $"Object #{obj2.Id} has the title {obj2.Title}",
            var val => $"Did not match: {val}"
        });


        printList.ToList().ForEach(Console.WriteLine);
